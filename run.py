...
eq_list = get_declarative_equations(model='gpt-3.5-turbo-instruct', question=question, prompt=DECLARATIVE_THREE_SHOT_AND_PRINCIPLES, max_tokens=600, stop_token='\n\n\n', temperature=0)
